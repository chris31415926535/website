...
As a next step, we can make an interactive map to see where the DAs are with the highest age-80+ population levels:
...
Two bright yellow spots jump out! However, if you explore the map you'll notice a trend: many of the lighter spots tend to contain facilities that care for older adults. The bright yellow spot to the east, for example, includes The Ottawa Hospital and at least one retirement home; the yellow spot to the west contains Forest Hill and some other retirement residences; and centrally on Riverside we can see the DA where St. Patrick's is located.
