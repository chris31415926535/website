...
image:
  ...
  preview_only: yes
header:
  image: '/headers/2021-02-19-ottawa-thumbnail.png'
projects: []
---
...
As a next step, we can make a static map to see where the DAs are with the highest age-80+ population levels. (We'll make an interactive map soon!  )
...
```{r leaflet_map_eighty, include = FALSE}
