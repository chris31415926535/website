...
tags:
  ...
  - onsr
subtitle: ''
summary: "This post introduces two custom functions for geocoding in R: one using the City of Ottawa's free geocoding service, and one using Google's geocoding API. I provide instructions on how to install the functions, and some code examples and interactive maps."
authors: []
